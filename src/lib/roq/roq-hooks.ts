...
export function useUserPreferenceFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useUserPreferenceFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.user_preference.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useUserPreferenceCount<T extends Prisma.user_preferenceCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.user_preferenceCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useUserPreferenceCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.user_preference.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useUserPreferenceFindManyWithCount<
  T extends Prisma.user_preferenceFindManyArgs,
  R extends { data: GetFindResult<Prisma.$user_preferencePayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.user_preferenceFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useUserPreferenceFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.user_preference.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useUserPreferenceFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useUserPreferenceFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.user_preference.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useWeatherAlertFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useWeatherAlertFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.weather_alert.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useWeatherAlertCount<T extends Prisma.weather_alertCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.weather_alertCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useWeatherAlertCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.weather_alert.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useWeatherAlertFindManyWithCount<
  T extends Prisma.weather_alertFindManyArgs,
  R extends { data: GetFindResult<Prisma.$weather_alertPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.weather_alertFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useWeatherAlertFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.weather_alert.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useWeatherAlertFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useWeatherAlertFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.weather_alert.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useWeatherDataFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useWeatherDataFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.weather_data.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useWeatherDataCount<T extends Prisma.weather_dataCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.weather_dataCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useWeatherDataCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.weather_data.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useWeatherDataFindManyWithCount<
  T extends Prisma.weather_dataFindManyArgs,
  R extends { data: GetFindResult<Prisma.$weather_dataPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.weather_dataFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useWeatherDataFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.weather_data.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useWeatherDataFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useWeatherDataFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.weather_data.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
