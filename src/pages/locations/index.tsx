...
export function LocationListPage(props: LocationListPageProps) {
  ...
  const queryParams = useMemo(
    () =>
      convertQueryToPrismaUtil(
        {
          relations: ['user', 'weather_data.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('weather_data', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'weather_data',
          header: 'Weather Data',
          accessorKey: 'weather_data',
          cell: ({ row: { original: record } }: any) => record?._count?.weather_data,
        }
      : null,
