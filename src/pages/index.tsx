  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Hail - your vigilant companion for severe weather alerts, keeping you informed and safe with real-time updates from the NOAA API."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1454789476662-53eb23ba5907?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx3ZWF0aGVyfGVufDB8fHx8MTcwMDAyNTM3NHww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Hail - your vigilant companion for severe weather alerts, keeping you informed and safe with real-time updates from the NOAA API.`}
            </Text>
            <Box
